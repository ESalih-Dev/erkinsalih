export const FACTS = [
  ...
  'The first time I saw a scorpion was in my kitchen in Mexico. Fastforward that same year, I ate a scorpion in Thailand.',
  "I've memorised π to the first 50 digits 🧠",
  'I broke 3 toes in a motorbike accident in Vietnam',
  'When I was younger my dream job was to become a pilot',
  'My secondary school produces poor A level grades. My grades were such a surprise they featured me in the local newspaper (and the article is still online 👀).',
  'I built my first computer when I was 13 years old 👶',
