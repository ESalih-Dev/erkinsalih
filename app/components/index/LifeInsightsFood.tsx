    ...
    return (
        <Card className="flex flex-col justify-between space-y-6 border-none bg-slate-900 p-12 md:flex-row md:space-x-12 md:space-y-0">
            <div className="whitespace-pre-wrap text-xl leading-9 text-muted-foreground md:w-1/2">
                ...
                I'm just travelling to eat my way around the world 😄 {`\n`}
                No matter how I look at it, food makes up a huge part of my life
                and the food markets and restaurants are the first thing I look
                at when I'm planning my trips. I was recently asked:{`\n\n`}
                <div className="flex flex-row font-semibold italic">
                    <span>Q: </span>
                    <span>
                        What's one thing you always do when visiting a new
                        place?
                    </span>
                </div>
                ...
                {`\n`}Besides from food, a good cup of coffee can make my day.
                At home I grind my own beans for a V60 filter (topped with a bit
                of frothed milk 🤌). Out and about, my go-to is a flat white
                with my current favourite spots in London being{' '}
                <Link
