...
export const PageToggle = () => {
    ...
    return (
        <div
            className={
                'fixed left-1/2 top-0 z-10 flex translate-x-[-50%] space-x-4 rounded-b-xl border-b-2 border-l-2 border-r-2 bg-slate-950 px-4 py-2 text-center hover:bg-slate-900'
            }
